...
logger.debug(f"Initializing {N} workers")
...
# scheduler.crawl("https://www.archwiki.org",depth=5)
scheduler.crawl("https://en.wikipedia.org/wiki/Jaypee_Institute_of_Information_Technology",depth=5)
